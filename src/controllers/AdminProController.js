...
const InvitarProfesional = (req,res) => {
    ...
    try{
        if(correo.length != 0){
            let mensaje = 'Se le invita a participar en el sistema de encuestas ingresando al siguiente link : https://sys-encuestas-api.herokuapp.com/Profesional/RegPro';
            var mailOptions = {
